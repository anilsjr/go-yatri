...
class _MapHomePageState extends State<MapHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        backgroundColor: widget.isPickupSelection ? Colors.green : Colors.red,
        title: Text(
          widget.pickupLocation != null && widget.dropLocation != null
              ? 'Route Map'
        ...
        actions: [
          // Add refresh button to reset the map view if needed
  ...
  Widget _locatePathBtn(MapController mapController) {
    return Positioned(
      ...
      child: FloatingActionButton(
        ...
        backgroundColor: Colors.white,
        mini: true,
        onPressed: () => mapController.fitCameraToPolyline(),
        child: const Icon(
